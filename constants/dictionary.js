// FIXME(@drapegnik): replace it with real internationalization
export default {
  // auth
  ...
  // email
  email: 'Пошта',
  badEmail: "Гэта пошта з'яўляецца несапраўднай",
  // password
  password: 'Пароль',
  passwordAgain: 'Пацвердзіць пароль',
  badPassword: 'Пароль занадта кароткі (мінімум 7 знакаў)',
  passwordsEqual: 'Паролі супалі',
  passwordsNotEqual: 'Паролі не супадаюць',
  forgotPassword: 'Забыліся на пароль?',
  // articles
  next: 'Далей',
  addLocale: 'Дадаць пераклад',
  // footer
